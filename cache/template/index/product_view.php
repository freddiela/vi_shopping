...
<div class="content" style="padding-top:0">
	...
	<div class="pro_box">
		<div class="pro_left">
			...
			<div class="clear"></div>
			<a href="javascript:collect_add('<?php echo $info['product_id'] ?>');" class="sctj fl" data-i18n-text="收藏商品">收藏商品</a>
			<div class="mat10 fxlj fr">
				<div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="Chia sẻ trên không gian QQ"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="chia sẻ trên Sina Weibo"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="Chia sẻ trên Tencent Weibo"></a><a href="#" class="bds_renren" data-cmd="renren" title="Chia sẻ trên Renren"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="Chia sẻ trên WeChat"></a></div>
		...
		<div class="fl proinfo">
			...
			<div class="hd_box">
				...
				<span class="fr font13"  >Khoảng cách kết thúc：<span id="huodong_time" endtime="<?php echo $info['huodong_etime'] ?>"></span></span>
				<div class="clear"></div>
			</div>
			<?php endif;?>
			<div class="proinfo_box">
				...
				<?php endif;?>
				<tr>
					<td width="50" data-i18n-text="价格">价格</td>
					<td>
						<span class="jg_price">
			...
			<div class="xl_box">
				<span class="xl_li">Phí vận chuyển：<?php if($info['product_wlmoney'] == 0):?>Miễn phí vận chuyển<?php else:?>₫ <?php echo $info['product_wlmoney'] ?><?php endif;?></span>
				<span class="xl_li">Bán chạy：<?php echo $info['product_sellnum'] ?> chiếc</span>
				<span class="xl_li" style="border-right:0;" >Phần thưởng：<span class="cgreen"><?php echo $info['product_point'] ?></span> Tích điểm</span>
				<div class="clear"></div>
			</div>
			...
			<tr>
				...
				<td>
					...
					<a href="<?php echo pe_url('quan-'.$v['quan_id']) ?>" target="_blank"><span class="yhq_btn1"><span class="yhq_q" data-i18n-text="券"></span>₫ <?php echo $v['quan_money'] ?></span></a>
					<?php endforeach;?>
				</td>
			</tr>
			<?php endif;?>
			...
			<tr>
				...
				<td class="shuliang">
					...
					<span class="fl c999 mal10 mat3 font12">Tồn kho<span id="product_num"><?php echo $info['product_num'] ?></span>Miếng</span>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>
					...
					<div class="jiagwc_1"><i></i>Hàng hóa đã được loại bỏ</div>
					<?php elseif($info['product_num']==0):?>
					<div class="jiagwc_1"><i></i>Đã bán hết</div>
					<?php elseif($info['product_type']=='virtual'):?>
					<a href="javascript:buy_btn('buy', '<?php echo $info['product_id'] ?>');" class="fl ljgm" data-i18n-text="立即购买">Mua ngay bây giờ </a>
					<?php else:?>
					<a href="javascript:buy_btn('buy', '<?php echo $info['product_id'] ?>');" class="fl ljgm" data-i18n-text="立即购买">Mua ngay bây giờ </a>
					<a href="javascript:buy_btn('add', '<?php echo $info['product_id'] ?>');" class="fl jiagwc"><i></i>Thêm vào giỏ hàng</a>
					<div class="clear"></div>
					<?php endif;?>
				</td>
			</tr>
		...
		<div class="proview_tj">
			<div class="proview_tjtt">
				<i></i>
				<span data-i18n-text="新品推荐" >新品推荐</span>
			</div>
			...
			<div class="c999 fr font12">Đã bán<?php echo $v['product_sellnum'] ?>Miếng</div>
			<div class="clear"></div>
			<?php endforeach;?>
			<div class="clear"></div>
		</div>
	...
	<div class="hot_box">
		<h3 class="hot_tt1" data-i18n-text="热销排行" >热销排行</h3>
		<div class="hotlist">
	...
	<div class="fr xiangqing">
		<div class="caidan1" id="js_menu">
			<ul class="fl">
				<li class="sel"><a href="javascript:;" data-i18n-text="商品详情">商品详情</a><i></i></li>
				<li><a href="javascript:;">Đánh giá của người dùng <span class="corg">(<?php echo $info['product_commentnum'] ?>)</span></a><i></i></li>
			</ul>
		...
		<div class="promain js_menuhtml" style="display:none">
			<div class="plrate">
				<div class="plrate_l fl"><strong><?php echo $comment_rate_hao ?>%</strong><p class="c888 mat3">Tỷ lệ đánh giá tốt</p></div>
				<div class="plrate_m fl">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="60">Đánh giá tốt</td>
				...
				<div class="plrate_r">
					Người đã mua sản phẩm có thể tiến hành bình luận
					<div class="mat8"><a href="<?php echo $pe['host_root'] ?>user.php?mod=order&state=wpj" target="_blank">Cho ra đánh giá<span class="font12 normal mal5"><?php echo $comment_point ?></span></a></div>
				</div>
				<div class="clear"></div>
			</div>
			<div class="plmenu" id="js_commentmenu">
				<a href="javascript:;" val="0" class="sel"><label><input name="comment_rate" type="radio" class="inputfix mar5">Toàn bộ(<?php echo $info['product_commentnum'] ?>)</label></a>
				<a href="javascript:;" val="hao"><label><input name="comment_rate" type="radio" class="inputfix mar5">Đánh giá tốt(<?php echo intval($comment_ratearr[0]) ?>)</label></a>
				<a href="javascript:;" val="zhong"><label><input name="comment_rate" type="radio" class="inputfix mar5">Đánh giá trung bình(<?php echo intval($comment_ratearr[1]) ?>)</label></a>
				<a href="javascript:;" val="cha"><label><input name="comment_rate" type="radio" class="inputfix mar5">Đánh giá tiêu cực(<?php echo intval($comment_ratearr[2]) ?>)</label></a>
			</div>
			<div id="js_commenthtml">
				...
				<div class="pj_box">
					...
					<div class="pj_r">
						...
						<div class="mjhf">Người bán phản hồi：{{v.comment_reply_text}}</div>
...
function buy_btn(act, id) {
	...
	if ($(":input[name='product_guid']").val() == '') {
		pe_tip('Vui lòng chọn thông số kỹ thuật sản phẩm', 'error');
		return;		
	}
		...
		if (json.result == true) {
			if (act == 'buy') {
				...
				layer.open({
					...
					closeBtn: 1,
					id: 'order_add',
					content: '<div class="gw"><p>Sản phẩm đã được thêm vào giỏ hàng！</p><a class="gw2" href="<?php echo pe_url("cart") ?>">Để giải quyết</a><a class="gw1" href="javascript:layer.closeAll();">Tiếp tục mua sắm</a><div class="clear"></div></div>'
				});
			}
		}
	})
