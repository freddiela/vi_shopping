...
<div class="right">
	<div class="now">
		<a href="webadmin.php?mod=taocan" class="sel">套餐列表（<?php echo $tongji['all'] ?>）<i></i></a>
		<a href="webadmin.php?mod=taocan&act=add" id="fabu">添加套餐</a>
		<div class="clear"></div>
	</div>
	<div class="right_main">
		...
		<tr>
			...
			<th class="bgtt" width="100">套餐价格</th>
...
<!--			<th class="bgtt" width="100">用户可购买数量</th>-->
			...
			<tr>
				...
				<td><img src="<?php echo pe_thumb($v['huodong_pic']) ?>" style="width:33px;" /></td>
				<td class="aleft"><span class="cblue"><?php echo $v['huodong_tag'] ?></span><p><?php echo $v['huodong_desc'] ?></p></td>
				<td>₫<?php echo $v['huodong_price'] ?></td>
...
<!--				<td><?php echo $v['huodong_count'] ?></td>-->
				<td>
					<a href="webadmin.php?mod=taocan&act=edit&id=<?php echo $v['huodong_id'] ?>" class="admin_edit mar5">修改</a>
					<a href="webadmin.php?mod=taocan&act=del&id=<?php echo $v['huodong_id'] ?>&token=<?php echo $pe_token ?>" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
				</td>
			</tr>
			<?php endforeach;?>
		</table>
