	...
	<div class="index_right">
		...
		<div class="xtxx mab15">
			...
			<tr>
				...
				<td style="border-top:0" class="corg">HUANGQIU_v<?php echo $ini['xaoyao']['version'] ?></td>
			</tr>
			
			<tr>
				<td align="right" class="c888">QQ：</td>
				<td>161089807</td>
			</tr>
			<tr>
		...
		<div class="xtxx mab15">
			<div class="xt_tt"><span>免责声明</span></div>
			<div class="gfdt" style="color:red;">
				本程序只供测试研究，不得使用于非法用途，不得违反国家法律，不得进行违法行为，否则后果自负！购买以后用作他用附带的一切法律责任后果都由购买者承担于本店无任何关系！
			</div>
		</div>
	</div>
</div>
