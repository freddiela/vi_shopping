...
<div class="wgw_box">
	...
	<div class="g_btn"><a href="<?php echo $pe['host_root'] ?>">Đi loanh quanh</a></div>
</div>
<div class="content" style="display:none;padding-bottom:60px">
	...
	<div class="cart_list js_cart" cart_id="<?php echo $v['cart_id'] ?>">
		<?php if($v['error']['del']):?>
		<div class="cart_shixiao">Sự vô hiệu</div>
		<?php else:?>
	...
	<?php endforeach;?>
	<div class="add_tj">
		<div class="add_qx"><span onclick="checkall_btn()"><i></i>chọn tất cả</span></div>
		<div class="add_heji">Tổng：<span class="corg font16">¥ <span id="order_money"><?php echo $money['order_money'] ?></span></span></div>
		<div class="add_tjbtn">
			<input type="hidden" name="pe_token" value="<?php echo $pe_token ?>" />
			<input type="hidden" name="pesubmit" />	
			<a href="javascript:cart_submit();">Giải quyết  <span class="font12">( <span class="font14" id="order_num"><?php echo $money['order_num'] ?></span> )</span></a>
