	...
	<div class="tuijian_list">
		...
		<div class="prolist" <?php if(($k+1)%4==0):?>style="margin-right:0"
			...
			<?php endif;?>
				<div class="prolist_img">
					...
					<div class="ms_time">
						...
						<span class="timer-text">距拼团开始</span>
			...
			<div class="qg_box">
				...
				<?php if($v['huodong_stime'] >= time()):?>
				<a href="#" title="<?php echo $v['product_name'] ?>" class="qg_r" style="background-color: #a8a0a0;"><?php echo $v['product_ptnum'] ?>人团</a>
				<?php else:?>
				<?php if($v['isUser'] == 1):?>
				<a href="<?php echo pe_url('product-'.$v['product_id']) ?>" title="<?php echo $v['product_name'] ?>" target="_blank"
					class="qg_r"><?php echo $v['product_ptnum'] ?>人团</a>
				<?php else:?>
				<a title="<?php echo $v['product_name'] ?>" class="qg_r" style="background-color: #a8a0a0;">无参加资格</a>
				<?php endif;?>
