...
switch ($act) {
        //####################// 折扣列表 //####################//
    case 'zhekou':
        $sqlfield = " `product_user_id`,`product_id`,`product_name`,`product_logo`,`product_money`,`product_smoney`,`huodong_etime`,`huodong_stime`";
        ...
        //####################// 拼团列表 //####################//
    case 'pintuan':
        $sqlfield = " `product_user_id`,`product_id`,`product_name`,`product_logo`,`product_money`,`product_smoney`,`huodong_etime`,product_ptnum,`huodong_stime`";
