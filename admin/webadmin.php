...
$adminmenu[1] = array(
	...
	'subnav' => array(
		...
		array('name' => '虚拟评价', 'menumark' => 'comment_fake', 'url' => 'webadmin.php?mod=comment_fake')
	)
);
$adminmenu[3] = array(
	'headnav' => '交易中心',
	'subnav' => array(
		...
		array('name' => '订单回收', 'menumark' => 'order_recovery', 'url' => 'webadmin.php?mod=order_recovery'),
		array('name' => '余额宝', 'menumark' => 'money_deposit', 'url' => 'webadmin.php?mod=money_deposit'),
	)
);
$adminmenu[5] = array(
	'headnav' => '营销中心',
	'subnav' => array(
		...
		array('name' => '优惠套餐', 'menumark' => 'taocan', 'url' => 'webadmin.php?mod=taocan'),
// 		array('name' => '活动时间配置', 'menumark' => 'activity_time', 'url' => 'webadmin.php?mod=activity_time'),
	)
);
$adminmenu[4] = array(
	'headnav' => '用户中心',
